...
// check if search movies alreadyInMovies or not id yes change text of add btn
const alreadyInMovies = state.movies.moviesList.filter((m)=>m.imdbID === movie.imdbID);
      ...
      <div className={styles.movieSearchBox}>
          <div className={styles.movieBox} >
                ...
                <div className={styles.movieDetails}>
                    ...
                    <div>
                      {
                        alreadyInMovies.length === 0?
                        <input className={styles.addToMoviesBtn} type='button' value='Add To Movies' onClick={addToMoviesClickHandler}></input>
                        :
                        <input className={styles.addToMoviesBtn} type='button' value='Already Added' disabled></input>
                      }
